...
connect_positions<- mongo("positions", url = "mongodb://pauline:iopqwe@csdm-cn:25555/ais")

#Connect to vessel names collection
connect_vessels<- mongo("vessels", url = "mongodb://pauline:iopqwe@csdm-cn:25555/ais")
